        ...
        <Tabs defaultActiveKey="servicesList" id="main-tabs">
          <Tab eventKey="servicesList" title="Services">
            <div style={{marginTop: '10px'}}>
                ...
                <FeatureTable onSelect={this.onEndpointChange}> 
          ...
          <Tab eventKey="testBench" title="Test bench">
            <div style={{marginTop: '10px'}}>
              ...
              <ReconciliationServiceInput onChange={this.onEndpointChange} endpoint={this.state.endpoint} manifest={this.state.manifest} />
